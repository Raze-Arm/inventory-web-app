...
export const MODAL_ERROR_MESSAGE = {
    SHOW: 'SHOW MODAL ERROR MESSAGE ',
    CLOSE: 'CLOSE MODAL ERROR MESSAGE ',
}
...
export const GET_USER_BY_USERNAME = {
    LOAD: 'GET USER BY USERNAME LOAD',
    SUCCESS: 'GET USER BY USERNAME SUCCESS',
    FAILED: 'GET USER BY USERNAME FAILED'
}
